// Import database handler utama dari lowdb
//import { Low } from "lowdb";

// Adapter untuk baca/tulis ke file JSON
//import { JSONFile } from "lowdb/node";

import { Low, JSONFile } from '../modules/lowdb.js';

// Custom adapter untuk MongoDB (jika kamu pakai database online)
...
export default async function initDatabase() {
  ...
  global.loadDatabase = async function loadDatabase() {
    ...
    // Info ke console bahwa database siap
   // console.log("[DB] Loaded & schema initialized");
  };
